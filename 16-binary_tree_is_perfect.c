...
/**
 * is_leaf - A function that checks if a node is a leaf of a binary
 * tree.
...
/**
 * depth - A function that returns the depth of a given node in a
 * binary tree.
...
/**
 * is_perfect_recursive - A function that checks if a binary tree
